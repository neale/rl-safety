...
from . import ddpg_baseline
from .wrappers import SafeLifeWrapper


class SafeLifeBaseDDPG(ddpg_baseline.StableDDPG):
    """
    ...
    def __init__(self, logdir=ddpg_baseline.DEFAULT_LOGDIR, **kwargs):
        self.logdir = logdir
        print (self.num_env)
        envs = [
            #SafeLifeWrapper(
...
class SafeLifeDDPG(SafeLifeBaseDDPG):
    """
