...
def sac_cnn(scaled_images, **kwargs):
    activ = tf.nn.relu
...
class PolicySAC(FeedForwardPolicy):
    def __init__(self, *args, **kwargs):
        super(PolicySAC, self).__init__(*args, **kwargs,
                                        n_env=1,
                                        n_steps=20,
                                        n_batch=20,
                                        cnn_extractor=sac_cnn,
                                        feature_extraction="cnn")

class StableSAC(object):
    def __init__(self, envs, logdir=DEFAULT_LOGDIR, saver_args={}, **kwargs):
        ...
        """
        self.gamma = 0.99
        self.lmda = 0.95  # generalized advantage estimation parameter
        ...
        self.model = SAC(**sac_args) # Nature Policy
